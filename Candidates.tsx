    ...
    <div className="flex-1 flex flex-col gap-6 min-h-0">
      ...
      {candidates.length > 0 ? (
        ...
        <div className="glass-card p-16 flex flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="font-display font-semibold text-white text-lg">No Candidates Yet</p>
          <p className="text-sm text-muted">Candidates haven't been registered for this election.</p>
        </div>
      )}
